          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div className="bg-inherit">
                ...
                >
                  <span
                    className={`relative my-1.5 block h-0.5 w-[30px] dark:bg-black  transition-all duration-300 ${
                      navbarOpen ? " top-[7px] rotate-45 bg-black" : " "
                    }`}
                  />
                  <span
                    className={`relative my-1.5 block h-0.5 w-[30px] dark:bg-black transition-all duration-300 ${
                      navbarOpen ? "opacity-0 bg-black" : " "
                    }`}
                  />
                  <span
                    className={`relative my-1.5 block h-0.5 w-[30px] dark:bg-black transition-all duration-300 ${
