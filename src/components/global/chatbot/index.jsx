  ...
  return (
    <>
      ...
      <div
        ...
        className="z-50 fixed bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px] h-[634px]"
      >
        {/* <!-- Heading --> */}
        <div className="flex flex-col space-y-1.5 pb-6 bg-gray-900 rounded-lg py-4 px-3">
          <h2 className="font-semibold tracking-tight text-blue-600 self-center text-3xl">
            Zidni
          </h2>
          <p className="text-sm text-[#6b7280] leading-3 self-center">
            Welcome to our AI assisstant
          </p>
        </div>

        {/* <!-- Chat Container --> */}
        <div
          className=" h-[474px] bg-gray-950"
